...
void main() {
  group('SubscriptionCard', () {
    ...
    group('when isExpanded is true', () {
      testWidgets('renders correctly', (tester) async {
        await tester.pumpApp(
          const SubscriptionCard(isExpanded: true, subscription: subscription),
        );
      ...
      testWidgets('adds SubscriptionPurchaseRequested to SubscriptionsBloc '
        ...
        when(
          () => appBloc.state,
        ).thenAnswer((_) => AppState.authenticated(user));

        when(
          () => subscriptionsBloc.state,
        ).thenAnswer((_) => SubscriptionsState.initial());
    ...
    group('when isExpanded is false', () {
      testWidgets('renders correctly', (tester) async {
        await tester.pumpApp(
          const SubscriptionCard(subscription: subscription),
        );
    ...
    testWidgets('renders bestValue Icon when isBestValue is true', (
      ...
      await tester.pumpApp(
        const SubscriptionCard(isBestValue: true, subscription: subscription),
      );
      expect(
